...
###-------------------------------------------------------------------------
###  Uncomment for Linux, using the script fort77 or yagfortran or old gfortran script
###  Compiler options for Linux GNU compilers include:
###   fort77 perl script (calls f2c/gcc) from RH or from yagfortran
###          or the yagfortran or the old gfortran shell script from f2c
...
# (note -fdefault-real-8 does not work in g77, use f2c instead)
#DP = -fdefault-real-8
#FFLAGS  = -O2 $(DP)
#CFLAGS  = -O2 $(DEFINE)
#AR = ar r
...
###-------------------------------------------------------------------------
###  Uncomment for Linux, using PGI gfortran
#FC = pggfortran
#CC  = gcc
##
...
# can cure it with a compile option:-). This is not a problem on xlf (gfortran) 
